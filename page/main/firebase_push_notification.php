<?php
	$firebase_api_key = "AAAAoX1t-xE:APA91bEm6KqsYDZzWetyyQbEyTB0RtUOPNQ-oX0TbK7VqaMGti92a8pXQbtGpWwjojsHAf3_WYMtDWzMk4zmYwyakM3nUo6ht-CAINTzULGqqojehA33nTCSm_hlPHz6jXeICxuSOVnb";
	$private_user_token = "ec3sElEvJmQ:APA91bFR_mkLBaQYm3jmA7syZ_EIFdvbtHG5V3pB9AQ9Udt8wZYWjRMjER7qjMU2AyOu2YE-Q_oQvasuNJZnBxCyHNnf5blh8hZwYm06KFfiXSCQenSwEX1po7O7j9bM96e4W9O4qJVr";
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					<hr />
					<h5>Private Token Example : <?php echo $private_user_token?></h5>
					<h5>Topic Example : sekolah (dengan catatan udah subscribe sekolah)</h5>
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<input type="text" required="" class="form-control" id="firebase_api" value="<?php echo $firebase_api_key?>" placeholder="Enter Firebase Server API Key" name="firebase_api">
						</div>
